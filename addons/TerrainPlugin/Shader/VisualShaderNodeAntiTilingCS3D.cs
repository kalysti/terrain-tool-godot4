...
public partial class VisualShaderNodeAntiTilingCS3D : VisualShaderNodeCustom
{
    ...
    public override StringName _GetOutputPortName(int port)
    {
        switch (port)
        {
    ...
    public override StringName _GetInputPortName(int port)
    {
        switch (port)
        {
            case 0: return "Color";
    ...
    public override string _GetCode(Array input_vars, Array output_vars, int mode, int type)
    {
        var heightStr = "";
